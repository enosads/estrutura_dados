...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btn_classificar->setObjectName(QStringLiteral("btn_classificar"));
        ...
        btn_atender_fisico->setObjectName(QStringLiteral("btn_atender_fisico"));
        ...
        btn_atender_juridico->setObjectName(QStringLiteral("btn_atender_juridico"));
        ...
        list_nao_classificados->setObjectName(QStringLiteral("list_nao_classificados"));

        gridLayout->addWidget(list_nao_classificados, 2, 2, 1, 1);

        list_fisicos = new QListWidget(centralWidget);
        list_fisicos->setObjectName(QStringLiteral("list_fisicos"));

        gridLayout->addWidget(list_fisicos, 2, 4, 1, 1);

        list_juridicos = new QListWidget(centralWidget);
        list_juridicos->setObjectName(QStringLiteral("list_juridicos"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QApplication::translate("MainWindow", "N\303\243o classificados", Q_NULLPTR));
        label_3->setText(QApplication::translate("MainWindow", "Jur\303\255dicos", Q_NULLPTR));
        label_2->setText(QApplication::translate("MainWindow", "F\303\255sicos", Q_NULLPTR));
        btn_inserir->setText(QApplication::translate("MainWindow", "Inserir", Q_NULLPTR));
        btn_classificar->setText(QApplication::translate("MainWindow", "Classificar", Q_NULLPTR));
        btn_atender_fisico->setText(QApplication::translate("MainWindow", "Atender f\303\255sico", Q_NULLPTR));
        btn_atender_juridico->setText(QApplication::translate("MainWindow", "Atender jur\303\255dico", Q_NULLPTR));
        btn_listar->setText(QApplication::translate("MainWindow", "Listar processos", Q_NULLPTR));
    } // retranslateUi
